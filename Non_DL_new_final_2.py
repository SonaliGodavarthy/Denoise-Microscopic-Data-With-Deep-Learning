...
def denoise_image_with_wiener(noisy_image):
    denoised_image = wiener(noisy_image, mysize=(5, 5))
...
addr = 'Mouse actin/diaphragm.tif'
...
for index in range(img.shape[0]):
    ...
    denoised_img = apply_filter(im, 4)
    # calculate PSNR
...
plot_results(gt, im, denoised_img, avg_psnr_input1, avg_psnr_denoised,4)
